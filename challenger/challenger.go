...
func (c *Challenger) ChallengeDA(index uint64, pointerIndex uint8, shareIndex uint32) (*types.Transaction, common.Hash, error) {
	return c.Ethereum.ChallengeDataRootInclusion(index, pointerIndex, shareIndex)
}
